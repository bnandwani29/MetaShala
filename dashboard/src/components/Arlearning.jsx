...
mgcms from "../assets/simple_alphabet.glb"
                ...
                <div className='flex md:flex-row flex-col flex-wrap'>
                        ...
                        <div className="row text-base">
                            <div className="flex flex-col ">
                                <div className="icon-box">
                                    <h4 className=" font-bold tracking-widest text-lg mt-10 mb-5">ALL ALPHABHETS</h4>
                                    <p className="description bg-zinc-700 text-white  rounded-lg p-4">The English alphabet consists of 26 letters, including vowels (A, E, I, O, U) and consonants. It forms the basis of written and spoken communication in English language.</p>
                                </div>
                            </div>
                    ...
                    <section className="container max-w-lg bg-slate-600 m-5 px-10 h-[800px]" data-aos="fade-up" date-aos-delay="200">
                        <div className="row">
                            <div className="col-lg-6 d-flex flex-column text-base justify-content-center p-5">
                                <div className="icon-box">
                                    <h4 className="font-bold tracking-widest mt-10 mb-5 text-lg">RUTHERFORD MODEL</h4>
                                    <p className="description bg-zinc-700 text-white rounded-lg p-4">
                                    Ernest Rutherford's 1911 model depicted the atom with a dense, positively charged nucleus orbited by negatively charged electrons, revolutionizing atomic understanding.
                                    </p>
                                </div>
                            </div>
                    ...
                    <section className="container max-w-lg bg-slate-600 m-5 px-10 h-[800px]" data-aos="fade-up" data-aos-delay="200">
                        <div className="row">
                            <div className="col-lg-6 d-flex flex-column text-base justify-content-center p-5">
                                <div className="icon-box">
                                    <h4 className="font-bold tracking-widest mt-10 mb-5 text-lg">ATOM MOLECULE</h4>
                                    <p className="description bg-zinc-700 text-white rounded-lg p-4">
                                    The atom model describes the structure of matter. It consists of a nucleus containing protons and neutrons, surrounded by electrons orbiting in distinct energy levels, forming the basis of modern physics.
                                    </p>
                                </div>
                            </div>
                            <div id="card" className='flex justify-center my-3'>
                    ...
                    <section className="container max-w-lg bg-slate-600 m-5 px-10 h-[800px]" data-aos="fade-up" data-aos-delay="200">
                        <div className="row">
                            <div className="col-lg-6 d-flex flex-column text-base justify-content-center p-5">
                                <div className="icon-box">
                                    <h4 className="font-bold tracking-widest mt-10 mb-5 text-lg">TAJ MAHAL</h4>
                                    <p className="description bg-zinc-700 text-white rounded-lg p-4">
                                    The Taj Mahal, located in Agra, India, is an iconic white marble mausoleum built by Emperor Shah Jahan in memory of his wife Mumtaz Mahal. It is a UNESCO World Heritage Site.
                                    </p>
                                </div>
                            </div>
                            <div id="card" className='flex justify-center my-3'>
